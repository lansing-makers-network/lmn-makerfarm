...
#define CUSTOM_MENDEL_NAME "LMN Prusa i3"
...
//  #define AUTO_BED_LEVELING_GRID
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 38.60      //CHANGE LATER!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Multiply offset readings by -1.
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -31.00
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -4.1   //last -12.06 Raise printhead by making offset less negative. -15.00 will print closer than 14.80
  #define Z_RAISE_BEFORE_HOMING 15      // was 4 (in mm) Raise Z before homing (G28) for Probe Clearance.
...
#define DEFAULT_MAX_FEEDRATE          {500, 500, 2, 22}    // (mm/sec)
